...
<main className="body-form">  
        <div className="form-container">
            ...
            <div className="form-group"><input type="email" id="email" placeholder="E-mail" required /></div>
            <div className="form-group"><input type="password" id="password" placeholder="Jelszó" required /></div>
            <button type="submit" className="btn-submit">Belépés</button>
            <div className="form-links"><a href="#" onClick={(e) => { e.preventDefault(); onRegisterClick(); }}>Nincs még fiókod? Regisztrálj!</a></div>
            </form>
        </div>
</main>
  )
